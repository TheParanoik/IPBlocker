...
<?php 
$UntrustedIPpage = ""; //link to Your page Untrusted IP
$proxybanpage = ""; //link to Your page if You ban proxy traffic
$ccbanpage = ""; //link to Your page if You ban County
$ipbanpage = "";//link to Your page if You ban IP
